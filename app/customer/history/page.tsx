...
export default function CustomerOrderDetailPage() {
  ...
  const orderId = params?.id as string; // Membaca ID dari URL dengan aman
  ...
  if (!order) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-8 text-center text-slate-800 space-y-4">
        ...
        <Link href="/customer/orders/history" className="px-4 py-2 bg-emerald-600 text-white rounded-xl font-bold">
          Kembali ke Riwayat
        </Link>
      </div>
    );
