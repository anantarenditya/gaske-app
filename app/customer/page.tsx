...
export default function CustomerDashboard() {
  ...
  const getStatusDisplay = (status: string) => {
    switch (status) {
      ...
      case 'IN_TRIP': return { text: 'Perjalanan Menuju Tujuan', color: 'bg-cyan-500/10 text-cyan-600 border-cyan-200', icon: <Navigation2 className="w-4 h-4 text-cyan-500" /> };
    ...
    <div className="min-h-screen bg-slate-900 pb-28 font-sans text-slate-100 relative">
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-800 border border-slate-700 w-full max-w-sm rounded-[2.5rem] p-6 shadow-2xl space-y-5 animate-fade-in text-center">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">Bagaimana layanan <strong className="text-blue-400 uppercase">{completedServiceName}</strong> Anda sebelumnya?</p>
            </div>
            ...
            <form onSubmit={handleSubmitRating} className="space-y-4">
              <textarea
                ...
                rows={3}
                className="w-full p-3 bg-slate-900/80 rounded-2xl text-xs text-white border border-slate-700 focus:ring-2 focus:ring-blue-500 resize-none"
              />
        ...
        <div className="max-w-md mx-auto relative z-10 space-y-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 bg-gradient-to-tr from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center shadow-xl shadow-blue-950/60 border border-white/30">
      ...
      <main className="max-w-md mx-auto px-4 -mt-8 space-y-6 relative z-20">
        {loading ? (
          ...
          <div className="bg-slate-800/95 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-blue-500/80 overflow-hidden">
            ...
            <div className="p-5 space-y-4">
              <div className="flex justify-between items-center pb-3 border-b border-slate-700/60">
                <span className="text-[10px] font-black tracking-widest text-blue-400 bg-blue-500/10 px-3 py-1 rounded-lg uppercase">{activeOrder.service}</span>
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-700/60">
                <a
                  ...
                  className="bg-slate-700/60 hover:bg-slate-700 text-blue-400 border border-slate-600/60 font-bold py-2.5 px-3 rounded-xl text-[11px] flex items-center justify-center gap-1.5 transition text-center shadow-sm"
                >
                  💬 WhatsApp Admin
                </a>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link href="/customer/ride" className="group relative bg-slate-800/80 backdrop-blur-xl p-5 rounded-[2rem] border border-slate-700/60 hover:border-blue-500/50 shadow-xl transition-all duration-300">
            ...
            <Link href="/customer/mart" className="group relative bg-slate-800/80 backdrop-blur-xl p-5 rounded-[2rem] border border-slate-700/60 hover:border-cyan-500/50 shadow-xl transition-all duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-600 text-white rounded-2xl flex items-center justify-center shadow-lg mb-4">
        ...
        {/* Kotak Kritik & Saran */}
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-5 rounded-3xl text-white shadow-xl space-y-3 border border-blue-500/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-blue-100 mt-0.5">Bantu kami meningkatkan layanan GASKE agar lebih baik!</p>
            </div>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full py-3 bg-white hover:bg-blue-50 text-blue-800 font-black text-xs rounded-2xl text-center shadow-lg transition"
          >
