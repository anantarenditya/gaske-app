    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 font-sans text-slate-100">
      <div className="w-full max-w-md bg-slate-800/90 backdrop-blur-xl border border-slate-700/60 p-8 rounded-[2.5rem] shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="w-14 h-14 bg-rose-500/10 text-rose-400 rounded-2xl flex items-center justify-center mx-auto border border-rose-500/25">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-3 bg-slate-900/90 rounded-2xl text-xs text-white border border-slate-700 font-bold focus:outline-none focus:ring-2 focus:ring-rose-500"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-2xl shadow-lg transition flex items-center justify-center gap-2 text-xs"
          >
        ...
        <div className="text-center pt-2 border-t border-slate-700/60 space-y-2">
          <p className="text-[11px]">
            ...
            <Link href="/customer/login" className="text-emerald-400 font-bold hover:underline">
              Login Pelanggan ➔
            </Link>
          </p>
        </div>
